...
template <> constexpr inline auto AdminDialog::qt_create_metaobjectdata<qt_meta_tag_ZN11AdminDialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "AdminDialog",
        "on_btnZmienStawke_clicked",
        "",
        "on_btnDodajAbonenta_clicked",
        "on_btnUsunAbonenta_clicked",
        "on_btnPokazZajete_clicked",
        "on_btnPokazWolne_clicked",
        "on_btnPokazHistorie_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_btnZmienStawke_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnDodajAbonenta_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnUsunAbonenta_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnPokazZajete_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnPokazWolne_clicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnPokazHistorie_clicked'
...
void AdminDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_btnZmienStawke_clicked(); break;
        case 1: _t->on_btnDodajAbonenta_clicked(); break;
        case 2: _t->on_btnUsunAbonenta_clicked(); break;
        case 3: _t->on_btnPokazZajete_clicked(); break;
        case 4: _t->on_btnPokazWolne_clicked(); break;
        case 5: _t->on_btnPokazHistorie_clicked(); break;
        default: ;
        }
    }
    (void)_a;
